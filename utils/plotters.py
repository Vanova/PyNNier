...
class NetworkVisualiser():
    ...
    def plot_neurons_cost_surface(self, network, data):
        ...
        ws1_1, ws2_1, cost_ws_1 = self._get_cost_surface(-3, 3, -3, 3, 100, network, x, y, id_layer, id_neuron)
    ...
    def plot_network_optimisation(self, network, list_of_ws, data, labels):
        ...
        # ws1 = [w[0] for w in list_of_ws]
        # ws2 = [w[1] for w in list_of_ws]
        ...
        # plot overview of cost function
        ax_1 = fig.add_subplot(1, 1, 1, projection='3d')
        ws1_1, ws2_1, cost_ws_1 = self._get_cost_surface(-3, 3, -3, 3, 10, network, data, labels)
        surf_1 = self._plot_surface(ax_1, ws1_1, ws2_1, cost_ws_1 + 1)
        ax_1.plot(ws1, ws2, 'b.')
        ax_1.set_xlim([-3, 3])
        ax_1.set_ylim([-3, 3])
